...
class CustomerSystem{
    public static void main(String[] args){
        ...
        do{
            ...
            if (userInput.equals(enterCustomerOption)){
                ...
                generateCustomerDataFile(infoData);
            }
            else{
    ...
    /*
    * Method Name: enterCustomerInfo 
    * Description: The user is able to enter the customer's information which then is concatenated into 
    *              a single string to be passed into a variable in main called info. The method will call on 
                   other methods to validate postal code and credit card once the uer has inputted values for those categories.
    ...
    */
    public static String enterCustomerInfo(int customerIdNum) {
        ...
        //Calls the method validatePostalCode to check if the postal code is in the CSV file 
        while(!validPostal) {
                //Ask user for input 
    ...
    * Description: The method is called on by enterCustomerInfo which will pass through the user's input for postal code.
                   This method will check from the postal codes provided, whether or not the postal codes exist in the Postal Code CSV file
                   It will be placed in a while loop, reprompting for the postal code.
    ...
    * Description: The method is called on by enterCustomerInfo which will pass through the user's input for creditCard
                   This method will check if the credit card number is a number greater than 9 and is a number following the Luhn Algorithm
                   It will be placed in a while loop, reprompting for the credit card number if the method return false.
    * @parameter: creditCardNumber (User input from enterCustomerInfo)
    * @return: boolean expression (True or False: if the credit card number is valid or not)
    */
    ...
    /*
    * Method Name: generateCustomerDataFile 
    * Description: The method is called from the main method when the user wants to the customer information to a CSV file. 
                   This method uses FileWriter and inputs the variable concatn which was the information from enterCustomerInfo
                   It will open a seperate file with a string in the format (ID, First Name, Last Name, City Name, Credit Card, Postal Code)
